...
export const products = [
  {
    ...
    price: 12,
    category: "Ancient Greek Literature", // Added category
    image: ErosTheBittersweetImage,
    description:
      "The book traces the concept of eros in ancient Greece through its representations in writings of the time.",
...

  {
    ...
    price: 19.88,
    category: "Romance", // Added category
    image: Zwgr,
    description:
      "Daniel Arasse takes the reader on a journey through the history of art from the invention of perspective to the disappearance of the motif.",
...

  {
    ...
    price: 18.99,
    category: "Historical Mysticism", // Added category
    image: Fiamma,
    description:
      "The book is a literary exploration of the traditional phenomenon whereby a person’s life flashes before them, as a 59-year-old Milanese antiquarian book dealer (who has lost his episodic memory due to a stroke) struggles to regain the one memory he seeks above all others: the face of the girl he loved ever since he was a student.",
    slug: "regina-loana",
  },
...

  {
    ...
    price: 17.99,
    category: "Comedy", // Added category
    image: Yokai,
    description:
...

  {
    ...
    price: 27.99,
    category: "Politics", // Added category
    image: Asia,
...

  {
    ...
    name: "On Beauty",
    price: 20,
    category: "History-Literature", // Added category
    image: Beauty,
    description:
      'The book "On Beauty" by Umberto Eco explores the concept of beauty and its significance in human culture and society. It is a philosophical exploration of the various dimensions of beauty, ranging from art and aesthetics to personal appearance and the role of beauty in social interactions.',
    slug: "beauty",
  },
];
